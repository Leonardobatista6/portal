...
<template>
    <div class="grid grid-cols-6 gap-4 ml-10 ">
        <div class="col-span-4 mt-3">
            ...
            <!-- inicio dos cards -->
            <div class="grid grid-cols-4 gap-6 bg-indigo-900 mt-2">
                ...
                <!-- inicio coluna 1 -->
                    ...
                    <!-- inicio dos cards -->
                            ...
                            <div
                                class=" mx-2 w-60 block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                                <div
                    ...
                    <!-- inicio coluna 2 -->
                    <div class="col-span-1 bg-indigo-900">
                        <!-- inicio dos cards -->
        ...
        <div class="col-span-2 bg-indigo-600 mx-10 mt-3 items-center">
            <div class="">
